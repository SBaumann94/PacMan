...
function oneFruit() { 
	if ( FRUIT_CANCEL_TIMER === null ) { 
		...
		else if (LEVEL === 3) FRUIT = "orange";
		else if (LEVEL === 4) FRUIT = "apple";
		else if (LEVEL === 5 ) FRUIT = "melon";
		/*
...
function drawFruit(ctx, f, x, y, size) {  
	...
	if ( f === "cherry" ) drawClosedChest(ctx, x, y, size);
	else if ( f === "strawberry" ) drawPizza(ctx, x, y, size);
	else if ( f === "orange" ) drawBurger(ctx, x, y, size);
	else if ( f === "apple" ) drawBeer(ctx, x, y, size);
	else if ( f === "melon" ) drawKey(ctx, x, y , size );
	/*
...
function drawPizza(ctx, x, y, size) {  
	...
	//inside
	ctx.beginPath();
	ctx.arc(size/2, size/2, size/2.5, 0, 2* Math.PI, true);
	...
	//pepperoni
	ctx.beginPath();
	ctx.arc(size/1.4, size/1.5, size/12, 0, 2* Math.PI, true);
	ctx.fillStyle = "brown";
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.arc(size/3, size/3.2, size/12, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.arc(size/1.5, size/3, size/12, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.arc(size/3, size/1.5, size/12, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.arc(size/2, size/2, size/12, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	//olives
	ctx.beginPath();
	ctx.arc(size/1.4, size/2, size/20, 0, 2* Math.PI, true);
	ctx.fillStyle = "black";
	ctx.fill()
	ctx.closePath();
	
	ctx.beginPath();
	ctx.arc(size/2, size/1.4, size/20, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.arc(size/2, size/3, size/20, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();
	
	ctx.beginPath();
	ctx.arc(size/3, size/2, size/20, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();
}
...
function drawBurger(ctx, x, y, size) {  
	...
	ctx.fillStyle = "orange";
	ctx.lineWidth = 4;
	ctx.arc(size/1.3, size/2, size/4, 0* Math.PI, 1* Math.PI, true);
	ctx.fill()
	ctx.stroke();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "brown";
	ctx.rect(size/2.75, size/1.75, size/1.2, size/4);
	ctx.fill()
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "green";
	ctx.rect(size/2.75, size/2, size/1.2, size/8);
	ctx.fill()
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "orange";
	ctx.rect(size/2.375, size/1.225, size/1.4, size/4);
	ctx.fill()
	ctx.closePath();
}

function drawBeer(ctx, x, y, size) {  
	...
	ctx.lineWidth = 4;
	ctx.arc(size/1.3, size/2, size/4, 0.5* Math.PI, 1.5* Math.PI, true);
	ctx.stroke();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "white";
	ctx.rect(size/10, size/14, size/1.5, size/1.2);
	ctx.fill()
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "#E4B114";
	ctx.rect(size/8, size/7, size/1.7, size/1.4);
	ctx.fill()
	ctx.closePath();
}

function drawClosedChest(ctx, x, y, size) {  
	...
	ctx.beginPath();
	ctx.fillStyle = "brown";
	ctx.rect(size/3.8, size/2.5, size/1.25, size/2);
	ctx.fill()
	ctx.closePath();
	...
	ctx.fillStyle = "brown";
	ctx.lineWidth = 8;
	ctx.arc(size/1.5, size/2, size/4, 0* Math.PI, 1* Math.PI, true);
	ctx.fill()
	ctx.stroke();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.rect(size/3, size/6, size/7, size/1.3);
	ctx.stroke();
	ctx.closePath();

	
	ctx.beginPath();
	ctx.rect(size/1.5, size/6, size/7, size/1.3);
	ctx.stroke();
	ctx.closePath();
	
	ctx.beginPath();
	ctx.rect(size/1, size/6, size/7, size/1.3);
	ctx.stroke();
	ctx.closePath();

	//horizontal line
	ctx.beginPath();
	ctx.rect(size/10, size/2, size/1, size/100);
	ctx.stroke();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.fillStyle = "gray";
	ctx.rect(size/2.1, size/3, size/3, size/3);
	ctx.fill()
	ctx.closePath();
	...
	ctx.fillStyle = "black";
	ctx.lineWidth = 8;
	ctx.arc(size/1.55, size/2.2, size/9, 0, 2* Math.PI, true);
	ctx.fill()
	ctx.closePath();

	ctx.beginPath();
	ctx.rect(size/1.775, size/2.1, size/6, size/6);
	ctx.fill()
	ctx.closePath();
